...
st.markdown("""
    ...
    .stApp {
        background-image: url("https://elements.envato.com/es/red-futuristic-background-BGM4ZKF?srsltid=AU7gw4XIvufUBoaB5pTwYFBL2ye5IPlSFMkFKXnhg8GvVBT20MLXNpgH"); /* <-- PEGA AQUÍ LA URL DE TU FONDO */
